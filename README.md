...
- [Contribution Guidelines](https://github.com/bids-standard/bids-specification/blob/master/CONTRIBUTING.md)
- [BIDS Governance](https://bids.neuroimaging.io/governance.html)
- [Community Forum](https://neurostars.org/tag/bids)
...
- **Mailing List**: [bids-discussion@googlegroups.com](mailto:bids-discussion@googlegroups.com)
- **GitHub Discussions**: [bids-standard discussions](https://github.com/bids-standard/bids-specification/discussions)
- **Neurostars Forum**: [neurostars.org/tag/bids](https://neurostars.org/tag/bids)

### During the Hackathon
- **Slack Workspace**: TBD (will be shared closer to the event)
- **Video Conferencing**: TBD
- **In-Person Location**: TBD

## Organizers

- **BIDS Steering Group**: [List of members](https://bids.neuroimaging.io/governance.html#bids-steering-group)
- **Workshop Leads**: TBD
- **Project Mentors**: TBD
...
- **TBD**: Project proposal deadline
- **TBD**: OHBM Hackathon 2026 dates
- **TBD**: BIDS Workshop (1.5 days within hackathon)

## Code of Conduct

All participants are expected to follow the [BIDS Code of Conduct](https://github.com/bids-standard/bids-specification/blob/master/CODE_OF_CONDUCT.md) and the OHBM Hackathon Code of Conduct.

## License

This repository and its contents are licensed under [CC-BY-4.0](LICENSE).

---

**Questions?** Open an issue in this repository or reach out on the [Neurostars forum](https://neurostars.org/tag/bids).
